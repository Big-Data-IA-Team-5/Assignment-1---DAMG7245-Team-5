...
def extract_metadata(
    pdf_path, doc_id, company, fiscal_year, output_dir, unified_dir=None
):
    ...
    lab1_records = process_lab1_results(
        doc_id, company, fiscal_year, pdf_path, unified_base
    )
    ...
    lab2_records = process_lab2_results(
        doc_id, company, fiscal_year, pdf_path, unified_base
    )
    ...
    lab3_records = process_lab3_results(
        doc_id, company, fiscal_year, pdf_path, unified_base
    )
    ...
    lab4_records = process_lab4_results(
        doc_id, company, fiscal_year, pdf_path, unified_base
    )
    ...
    if lab4_records:
        ...
        markdown_lines.append(
            f"- Extraction method: Unified document understanding\n\n"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--fiscal-year", dest="fiscal_year", required=True, help="Fiscal year"
    )
