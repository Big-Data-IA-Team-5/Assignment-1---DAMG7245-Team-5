...
def main():
    ...
    parser.add_argument("--add-existing", action="store_true",
                       help="Add existing metrics files to DVC tracking")
    parser.add_argument("--create-config", action="store_true",
                       help="Update dvc.yaml with metrics configuration")
    parser.add_argument("--compare", action="store_true",
                       help="Show metrics differences between runs")
    parser.add_argument("--create-generator", action="store_true",
                       help="Create metrics summary generator script")
    parser.add_argument("--show-files", action="store_true",
                       help="Show discovered metrics files")
    ...
    if args.show_files or not any([args.add_existing, args.create_config, 
                                  args.compare, args.create_generator]):
