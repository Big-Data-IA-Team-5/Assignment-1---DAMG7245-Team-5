...
class DVCPipelineManager:
    ...
    def create_full_pipeline_stage(self, output_dir="data/parsed", use_hybrid_tables=True):
    ...
    def create_lab7_stage(self, pdf_file="data/raw/tesla.pdf", pages="5 12", mode="pages"):
    ...
    def create_combined_stage(self, output_dir="data/parsed", pdf_file="data/raw/tesla.pdf", 
                             pages="5 12", use_hybrid_tables=True):
...
def main():
    ...
    parser.add_argument("--pdf-file", default="data/raw/tesla.pdf",
                       help="PDF file to process with Lab 7")
    parser.add_argument("--pages", default="5 12",
                       help="Page range for Lab 7 processing")
    parser.add_argument("--lab7-mode", choices=["pages", "random", "all"],
                       default="pages", help="Lab 7 processing mode")
